...
<body>
	...
	<div class="container">
		...
		<div class="row clearfix" style="margin-top: 17%;">
			<div class="col-md-12 column">
				<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/user/login.action" method="post">
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">账户</label>
						<div class="col-sm-10">
							<input name="username" class="easyui-validatebox form-control" required="true" validType="userName" />
						</div>
					</div>
					<div class="form-group">
